...
/*     */     
/* 123 */     final JMenuItem configs = new JMenuItem("Configs (../../../home");
/* 124 */     configs.setEnabled(false);
/* 125 */     fileBrowser.add(configs);
/*     */     
/* 127 */     final JMenuItem notes = new JMenuItem("Notes ( ../../../etc )");
...
/*     */           public void actionPerformed(ActionEvent e) {
/* 415 */             String response = "";
/* 416 */             ClientGuiTest.this.currentFolder = "..";
/*     */             try {
/* 418 */               response = ClientGuiTest.this.invoker.showFiles("..");
...
/*     */           public void actionPerformed(ActionEvent e) {
    String response = "";
    /*     */             try {
        String old = ClientGuiTest.this.textField_1.getText();
        String new_ = ClientGuiTest.this.textField_2.getText();
        logger.logInfo("old: " + old);
        logger.logInfo("new: " + new_);



        /* 533 */               response = ClientGuiTest.this.invoker.changePW(old,new_);
        /* 534 */             } catch (MessageBuildException|htb.fatty.shared.message.MessageParseException e1) {
        /* 535 */               JOptionPane.showMessageDialog(controlPanel, "Failure during message building/parsing.", "Error", 0);
        /*     */
        /*     */
...
/* Location:              /home/user/htb/labs/main/fatty/exfil/ftp/fatty-client.jar!/htb/fatty/client/gui/ClientGuiTest.class
